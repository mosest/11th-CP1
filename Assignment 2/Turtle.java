 ...
 * DATE: 6/7/2012
 * VERSION: 1 (THIS SHOULD BE VERSION 0.1 BUT THAT IS A SILLY NUMBERING SYSTEM.)
 *
 *
...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    private static TreeMap<Long,ArrayList> turtleStates=new TreeMap<Long,ArrayList>();
    private static TreeMap<Long,ArrayList> redoStates=new TreeMap<Long,ArrayList>();
    ...
    private static HashMap<String,ArrayList<ArrayList>> keyBindings=new HashMap<String,ArrayList<ArrayList>>();
    private static HashMap<Turtle,ArrayList<ArrayList>> mouseBindings=new HashMap<Turtle,ArrayList<ArrayList>>();
    private static double centerX=0, centerY=0;
    private static double scale=1;
    private static TreeSet<String> keysDown=new TreeSet<String>();
    private static TreeSet<String> processedKeys=new TreeSet<String>();
    private static TreeSet<String> unprocessedKeys=new TreeSet<String>();
    private static long lastUpdate=0;
    private static long fps=30;
    private static final Object turtleLock=new Object();
    private int dragx=0,dragy=0,x=0,y=0,modifiers=0;
    ...
    private static int refreshMode=REFRESH_MODE_ANIMATED;
    ...
    private static int backgroundMode=BACKGROUND_MODE_TILE_RELATIVE;
    private static Turtle selectedTurtle=null;
 ...
 */
    ...
    {
        return storeCurrentState(false, false, 0,null);
    }
    private long storeAnimatedState()
    {
        return storeCurrentState(true, false, 0,null);
    }
    private long storeCurrentState(boolean animate, boolean isStamp,double dotSize,Color dotColor)
    {
    ...
    public long stamp()
    {
        long timeStamp=storeCurrentState(true, true,0,null);
        return timeStamp;
    }
    ...
    public long dot(String color)
    {
        ...
        long timeStamp=storeCurrentState(true, false,penWidth*3,c);
        return timeStamp;
    }
    ...
    public long dot(String color,double dotSize)
    {
        Color c=Turtle.getColor(color);
        if(c==null)c=penColor;
        long timeStamp=storeCurrentState(true, false,dotSize,c);
        return timeStamp;
    }
    ...
    {
        long timeStamp=storeCurrentState(true, false,dotSize,color);
        return timeStamp;
    }
   ...
   /**
    ...
    private void rollback()
    {
        ...
        synchronized(turtleLock)
        {
            ...
            if (removeKey!=0) redoStates.put(removeKey, turtleStates.remove(removeKey));
        }
    }
